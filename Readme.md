# Self-assessment question behaviour [![Build Status](https://travis-ci.com/moodleou/moodle-qbehaviour_selfassess.svg?branch=master)](https://travis-ci.com/moodleou/moodle-qbehaviour_selfassess)
